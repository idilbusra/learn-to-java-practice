...
public class C02_DataCasting {
    public static void main(String[] args) {
       ...
       byt = (byte) in2;
        ...
        byt = (byte) in4;
        System.out.println("1000000 byte olarak : " +byt);//64
        ...
        sayi=(byte)dbl3;
        System.out.println("140.32 byte olarak : "+sayi);//-116

        //2 kere casting var
        //1- double sayiyi once explicit narrowing ile byte'a ceviriyor//esitligin saginda
        //2- byte'a cevrilen sayiyi autowidening ile int'e cast ediyor//assignment ile
