...
public class C05_KarsilastirmaOperatorleri {
    public static void main(String[] args) {
        ...
        /*
        Karsilastirma operatorleri 2 variableí karsilastirip istenen sart saglaniyorsa TRUE
         sart saglanmiyorsa FALSE degeri ureten operatordir
         */
